...
def edit(request, post_id):
    if request.method == "POST":
        ...
        edit_post.save()
        return JsonResponse({"message": "Changes Done !", "data": data["content"]})
...
def remove_like(request, post_id):
    ...
    like.delete()
    return JsonResponse({"message": "Like Deleted from Database !"})
...
def add_like(request, post_id):
    ...
    newLike.save()
    return JsonResponse({"message": "Like Added to Database !"})
